...
func (in *NamepsaceAnnotator) DeepCopyInto(out *NamepsaceAnnotator) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamepsaceAnnotator.
func (in *NamepsaceAnnotator) DeepCopy() *NamepsaceAnnotator {
	if in == nil {
		return nil
	}
	out := new(NamepsaceAnnotator)
	in.DeepCopyInto(out)
	return out
}
